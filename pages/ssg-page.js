...
export default function SSGPage({ posts }) {
    return (
        <section>
            <h2 className="text-xl font-medium mb-3">SSG — getStaticProps()</h2>
            <p className="text-sm text-slate-600 mb-4">Generated at build time. Database changes require a rebuild to appear.</p>
